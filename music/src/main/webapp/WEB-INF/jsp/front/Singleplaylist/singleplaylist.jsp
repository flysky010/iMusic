...
<script src="/js/singleplaylist.js"></script>
</head>
<style>
.warp1{
	width:800px;
...
<body style="background-color:#F5F5F5">
	<%@ include file="../Common/nav.jsp" %>
		...
		<div class="warp2">
			<div class="imgDiv">
				<img src="${singlePlaylist.path}" class="img-top">
			</div>
			<div class="playlistDesc">
				<div class="tit">
					<img src="/images/playlistOfChina_18.png">
					<span class="titDesc">${singlePlaylist.title}</span>
				</div>
				<div class="author">
					<a href="/#">
				...
				<p id="album-desc-dot" class="intr"><b>介绍：</b>
					${singlePlaylist.pdesc}
				</p>
			</div>
					...
					<table class="table table-striped table-bordered table-hover t-des">
						...
						<tbody>
							<c:forEach items="${songs}" var="mItem" varStatus="st">
								<tr>
									<td class="td-t">
										<audio src="${mItem.path}" controls="controls" id="mp3Btn" class="mp3Btn">
										</audio>
										<input type="hidden" id="audioInput" value="${mItem.sid}">
									</td>
									<td class="td-t">
										<a href="/#">
											<span class="tlt-t">
									...
									<td class="td-t">
										<a href="javascript:void(0);" onclick="ShowDiv('MyDiv','fade',${mItem.sid})" title="收藏">
